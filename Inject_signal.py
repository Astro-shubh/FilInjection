...
parser = argeparse.ArgumentParser(description = "This script injects dispersed pulses (full-band/band-limited) in a noise filterbank file.")
...
modules.FilterbankInjection.inject_filterbank(in_file, out_file, period, width, dm, cf, bf)
